...
int	obj_loc(int obj);
int	fobn(const char *word);
int	fobna(const char *word);
int	fobnin(const char *word, int ct);
int	fobnc(const char *word);
int	fobncb(const char *word, int by);
int	fobnh(const char *word);
int	find_object_by_id(long int id);
int	fobn_can_take(const char *word);
int	getcom(void);
